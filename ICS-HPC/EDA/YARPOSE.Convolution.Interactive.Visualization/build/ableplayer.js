    ...
    AblePlayer.prototype.updateCookie = function(setting) {
        ...
        if (setting === 'transcript' || setting === 'sign') {
            ...
            if (!voiceLangFound) {
                ...
                newVoice = {
                    'name': this.prefDescVoice,
                    'lang': this.prefDescVoiceLang
                };
...
(function($) {
    ...
    AblePlayer.prototype.addControls = function() {
        ...
        for (var sec in controlLayout)
            if (controlLayout.hasOwnProperty(sec)) {
            ...
            this.youTubePlayer.addEventListener('onApiChange', function(x) {
                ...
                if (thisObj.captionLangPending) {
                    ...
                    thisObj.youTubePlayer.setOption('captions', 'track', {
                        'languageCode': thisObj.captionLangPending
                    });
...
(function($) {
    ...
    window.AccessibleSlider = function(mediaType, div, orientation, length, min, max, bigInterval, label, className, trackingMedia, initialState) {
        ...
        this.bodyDiv.on(
            'mouseenter mouseleave mousemove mousedown mouseup keydown keyup touchstart touchmove touchend',
            function(e) {
    ...
    AblePlayer.prototype.setFullscreen = function(fullscreen) {
        ...
        if (this.nativeFullscreenSupported()) {
            ...
            if (!this.fullscreenDialog) {
                ...
                this.fullscreenDialog = new AccessibleDialog($dialogDiv, this.$fullscreenButton, 'dialog', true, 'Fullscreen video player', $fsDialogAlert, this.tt.exitFullscreen, '100%', true, function() {
